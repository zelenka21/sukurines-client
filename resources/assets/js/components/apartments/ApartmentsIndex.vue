<template>
    <div>
        <div class="form-group">
            <router-link :to="{name: 'createApartment'}" class="btn btn-success">Create new apartment</router-link>
        </div>
            ...
            <div class="panel-body">
                ...
                <table class="table table-bordered table-striped">
                    ...
                    <tr v-for="apartment, index in apartments">
                        ...
                        <td>
                             <router-link :to="{name: 'viewApartment', params: {id: apartment.id}}" class="btn btn-xs btn-default">
                                View
                            </router-link>
                             <router-link :to="{name: 'viewListing', params: {id: apartment.id}}" class="btn btn-xs btn-success">
                                Jump
                            </router-link>
                            <router-link :to="{name: 'editApartment', params: {id: apartment.id}}" class="btn btn-xs btn-primary">
                                Edit
                            </router-link>
                            <a href="#"
